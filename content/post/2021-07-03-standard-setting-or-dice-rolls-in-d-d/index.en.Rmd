...
What I am particularly interested in is finding the probability that this would occur.
...
After the initial simulation was proposed, my friend also suggested changing the optimum criteria to include having at least two of the $Y_1, \dots, Y_5$ being greater than or equal to $15$. We execute this simulation below:
...
This problem is an excellent application of Monte Carlo methods, due to the nature of the rolling mechanism. I don't have the theoretical background to try to tackle this all using probability, though I suspect that a strong background in probability and combinatorics could probably lead to exact solutions for both of these situations.