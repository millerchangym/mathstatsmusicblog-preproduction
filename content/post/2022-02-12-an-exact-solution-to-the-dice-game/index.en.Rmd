...
A fact of Markov chains is that if $\mathbf{P}$ is a transition matrix for one transition (as given above), then $\mathbf{P}^n$ is the transition matrix for $n$ steps, with $n \geq 1$ an integer.
