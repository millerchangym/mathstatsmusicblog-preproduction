...
\begin{equation*}
\sum_{i=1}^{p}\beta_ix_i = \sum_{i=1}^{p}\left(z_i\beta_i-\dfrac{\lambda\beta_i^2}{2}\right) + \beta_0 = \sum_{i=1}^{p}z_i\beta_i-\dfrac{\lambda}{2}\sum_{j=1}^{p}\beta_j^2 + \beta_0  = 0\text{.}
\end{equation*}
This implies that
\begin{equation*}
