...
* To determine the number of bad spaces (rupoors, bombs) adjacent to a space, I performed a two-dimensional convolution, convolving all bad spaces with
\begin{equation}
\begin{bmatrix}
1 & 1 & 1 \\
1 & 0 & 1 \\
...
M = 300 # number of episodes for training
mode = "beginner"
